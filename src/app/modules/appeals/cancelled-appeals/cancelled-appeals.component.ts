...
@Component({
    selector: 'app-cancelled-appeals',
    templateUrl: './cancelled-appeals.component.html',
    styleUrls: ['./cancelled-appeals.component.css'],
})
export class CancelledAppealsComponent implements OnInit {
