...
@Component({
    selector: 'app-submitted-appeals',
    templateUrl: './submitted-appeals.component.html',
    styleUrls: ['./submitted-appeals.component.css'],
})
export class SubmittedAppealsComponent implements OnInit {
